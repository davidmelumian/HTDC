...
class ConsILREA implements  ILREA{
    REA fst;
    ILREA rst;
    ConsILREA (REA fst, ILREA rst) {
        this.fst= fst;
        this.rst= rst;
    }
}
...
class REAexp {
    ...
    ILREA i1 = new EmptyILREA();
    ILREA i2 = new ConsILREA(this.rea1,this.i1);
    ILREA i3 = new ConsILREA(this.rea2, this.i2);
    ILREA i4 = new ConsILREA(this.rea3, this.i3);
    REAexp () {}
}