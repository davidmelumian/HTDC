...
// a complete world,with ufo dropped by 3 pixels,aup remained the same,the player fired one shot.
// We divide the height of rectangle by 2, and then we subtract HEIGHT  and AUP (- 500 10)
    UFOWorld w3 = new UFOWorld(this.u2,this.a,this.ls);
WoWExamples () {}
}